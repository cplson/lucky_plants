...
export default async function Home() {
  return (
    <div className="bg-white rounded flex flex-col lg:flex-row sm:w-4/5 mx-auto mt-16">
      {/* <button className='hover:cursor-pointer hover:border-slate-800 border-2 my-4'>Shop Now</button> */}
      <div className="border-red-600 p-4 sm:pt-8 sm:px-8 z-10">
        ...
        <Link
          href={"/shop"}
          className="px-4 py-2 border-2 border-slate-600 text-xl 
      ...
      <div className="sm:-mt-16 border-black object-fit z-0">
        <Image
          className={""}
          width={1000}
          height={751}
